...
public class Camioneta extends Vehiculo {
    ...
    public Camioneta(long id_vehiculo, double kilometraje, String tipoCombustible, int modelo, String marca, boolean serviceAlDia, String categoria) {
    ...
    public double desgaste() {
        ...
        if ("diesel".equals(this.getTipoCombustible())) {
