...
public class Auto extends Vehiculo {
    ...
    public Auto(long id_vehiculo, double kilometraje, String tipoCombustible, int modelo, String marca, boolean serviceAlDia, String categoria) {
